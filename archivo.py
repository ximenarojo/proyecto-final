...
st.image(image, caption="Fuente: Condiciones Básicas de Calidad - SUNEDU.(octubre, 2018). Disponible en: https://www.sunedu.gob.pe/8-condiciones-basicas-de-calidad/")
st.image(image)
st.markdown("##")
