...
with st.sidebar:
    ...
    st.sidebar.write('Se presenta el avance y estatus del Licenciamiento Institucional de las Universidades peruanas. Incluye información de región y tipo de entidad.')
